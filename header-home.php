      ...
      >
        ...
        >
          ...
          >
            ...
            <!-- * ---- Desktop menu ---- * -->
            <div
              class="hidden lg:flex flex-row flex-1 items-center justify-between !ml-20"
            >
            <?php
              wp_nav_menu(array(
              ...
              >
                ...
                >
                  <a
                    href="#"
                    class="relative leading-[22.21px] font-semibold mix-blend-normal z-[0] !text-cornflowerblue-100"
                  >
                    Accueil
                  </a>
                  <img
