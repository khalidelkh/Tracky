...
<section class="max-w-[1550px] ml-auto flex justify-center items-center self-stretch pl-5 lg:pl-10 xl:pl-16 py-20 xl:py-24">
  <div class="mt-20 w-full max-w-[1620px] max-md:mt-10 max-md:max-w-full">
    <div class="flex gap-5 max-md:flex-col max-md:gap-0">
      <article class="flex flex-col w-2/5 max-md:ml-0 max-md:w-full max-lg:pr-5">
        <div class="self-stretch my-auto text-sm leading-6 text-zinc-700 max-md:mt-10 max-md:max-w-full">
          <h2 class="text-lg font-medium leading-7 text-cornflowerblue-100 max-md:max-w-full">
            Secteur
          </h2>
          <h1 class="mt-1 text-21xl-4 font-bold leading-[49px] text-blue-950 text-ellipsis max-md:max-w-full">
            TRANSPORT <br />
            <span class="text-blue-950">DE MARCHANDISE</span>
          </h1>
          <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/divider1.svg" alt="Representative image for transport de marchandise" class="mt-3 object-cover aspect-[20] fill-cornflowerblue-100 w-[60px]" />
          ...
          <a href="/secteur" class="block text-center px-10 py-5 mt-14 text-base font-bold leading-6 !text-white bg-cornflowerblue-100 rounded-sm max-md:px-5 max-md:mt-10 hover:text-white">En savoir plus</a>
        </div>
      </article>
      <div class="flex flex-col ml-5 w-3/5 max-md:ml-0 max-md:w-full">
        <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/pages/solutions-web/mockup-laptop.webp" alt="Image related to transport de marchandise" class="grow w-full aspect-[1.64] object-contain max-md:mt-9 max-md:max-w-full" />
      </div>
    </div>
  </div>
</section>
...
<!-- * Solution mobile * -->
<section class="max-w-screen-xl mx-auto flex flex-col items-center self-stretch pb-20 max-md:px-5">
  <header class="flex flex-col items-center max-w-full">
    <h2 class="text-lg font-medium leading-7 text-center text-sky-500">
      Soluttion mobile
    </h2>
    <h1 class="mt-1 text-21xl-4 font-bold text-center leading-[48.4px] text-blue-950 max-md:max-w-full">
      TRANSPORT DE MARCHANDISE
    </h1>
    <p class="mt-11 text-lg leading-7 text-center font-normal text-zinc-700 max-md:mt-10 max-md:max-w-full">
    ...
    <div class="flex gap-5 max-md:flex-col max-md:gap-0">
      <article class="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
        <section class="flex flex-col grow items-end max-md:mt-10">
          <figure class="flex justify-center ml-auto mr-0 items-center px-4 bg-cornflowerblue-100 h-[90px] rounded-[100px] w-[90px]">
            <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/icons/truck-location-icon.svg" class="w-full aspect-[1.39]" alt="Surveillance icon" />
          </figure>
          <h3 class="mt-5 text-3xl-2 font-bold leading-6 text-right text-midnightblue">
            TRACEZ ET SURVEILLEZ
          </h3>
          <p class="self-stretch font-normal mt-3.5 text-base leading-7 text-right text-ellipsis text-zinc-700">
            Vous pouvez visualiser d’un coup d’œil l’ensemble de vos
            traceurs, les renommer et vérifier leur état de santé.
          </p>
          <figure class="flex justify-center ml-auto mr-0 items-center px-6 mt-16 bg-cornflowerblue-100 h-[89px] rounded-[100px] w-[89px] max-md:px-5 max-md:mt-10">
            <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/icons/bell-icon.svg" class="w-full aspect-[0.93]" alt="Alert definition icon" />
          </figure>
          <h3 class="mt-5 text-3xl-2 font-bold leading-6 text-right text-blue-950">
      ...
      <figure class="flex flex-col m-0 w-[33%] max-md:ml-0 max-md:w-full">
        <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/logo/logo-without-text.webp" class="self-stretch m-auto object-contain w-full aspect-[1.23] max-md:mt-10" alt="" />
      </figure>
      <article class="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
        <section class="flex flex-col grow max-md:mt-10">
          <figure class="flex ml-0 mr-auto justify-center items-center px-4 bg-cornflowerblue-100 h-[90px] rounded-[100px] w-[90px]">
            <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/icons/subscription-icon.svg" class="w-full aspect-[0.97]" alt="Subscription offer icon" />
          </figure>
          ...
          <figure class="ml-0 mr-auto flex justify-center items-center px-4 mt-16 bg-cornflowerblue-100 h-[89px] rounded-[100px] w-[89px] max-md:mt-10">
            <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/icons/theive-icon.svg" class="w-full aspect-[1.23]" alt="Theft declaration icon" />
          </figure>
          <h3 class="mt-5 text-3xl-2 font-bold leading-6 text-blue-950">
            DÉCLAREZ UN VOL
          </h3>
...
<section class="relative z-20 pb-28 flex flex-col items-center self-stretch py-10">
  <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/pages/solutions-web/mockup-tablet-2.webp" class="relative z-10 w-full aspect-[1.45] max-w-[1164px]" alt="" />
  <h1 class="mt-16 z-10 text-21xl-4 font-semibold leading-normal text-center text-sky-500 max-md:mt-10 max-md:max-w-full max-md:text-21xl-4">
    Télécharger votre app
  </h1>
  <p class="m z-10 font-normal text-lg leading-7 text-center text-white max-md:max-w-full">
    Nous vous offrons des solutions sur mesure pour le kilomètrage
    parcouru, la consommation de l'historique des trajets...
  </p>
  <a href="/contact" class="justify-center mb-36 z-10 px-10 py-7 mt-12 text-xl font-bold leading-7 !text-white bg-cornflowerblue-100 rounded-sm shadow-lg max-md:px-5 max-md:mt-10 hover:text-white" tabindex="0">DEMANDEZ UN DEVIS</a>
  <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/bgs/bg-roades.webp" class="absolute object-cover top-1/3 min-h-[700px] md:top-[45%] lg:top-[45%] xl:top-1/2 -translate-y-1/2 -z-1 self-stretch mt-0 w-full aspect-[1.56] max-md:mt-0 max-md:max-w-full" alt="" />
  <section class="z-20 flex flex-col items-center px-16 pt-20 pb-5 mt-0 w-full text-center bg-white max-w-[1444px] rounded-[65px] max-md:px-5 max-md:mt-0 max-md:max-w-full">
    <div class="flex flex-col px-5 mt-10 max-w-full w-[869px]">
      <h2 class="self-center text-21xl-4 font-bold leading-loose text-blue-950 max-md:text-21xl-4">
        Lorem Doloorr
      </h2>
      <p class="mt-12 font-normal text-lg leading-7 text-zinc-700 max-md:mt-10 max-md:max-w-full">
      ...
      <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/pages/solutions-web/mockup-tablette-3.webp" class="mt-20 w-full aspect-[1.56] max-md:mt-10 max-md:max-w-full" alt="" />
    </div>
  </section>
</section>
