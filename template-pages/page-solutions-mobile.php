...
<h1 class="mt-24 text-35xl-5 font-bold leading-[60.69px] text-white">
          ...
          >
            ...
            <section
        class="flex max-w-screen-xl mx-auto justify-center items-center self-stretch px-5 lg:px-16 xl:px-0 py-14 lg:py-20 max-md:px-5"
      >
        <div class="sm:mt-10 max-w-full">
          <div class="flex gap-5 max-md:flex-col max-md:gap-0">
            <article class="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
              <section
                class="flex flex-col self-stretch my-auto text-sm leading-6 text-zinc-700 max-md:mt-10 max-md:max-w-full"
              >
                <h2
                ...
                <h1
                  class="mt-1 text-21xl font-bold leading-[49px] text-midnightblue text-ellipsis max-md:max-w-full"
                >
                ...
                <img
                  loading="lazy"
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/e55424b4a19e3b2b3bfbf97759edcfcbc7dab325c89d62e1981b277aa3e9e16f?apiKey=abfef66409b54744a10f8b8237a66f58&"
                  alt=""
                  class="m-0 aspect-[20] fill-sky-500 w-[60px]"
                />
            ...
            <section
        class="max-w-screen-xl mx-auto flex flex-col items-center self-stretch px-5 lg:px-16 xl:px-0 pb-20 max-md:px-5"
      >
        <div class="flex flex-col items-center max-w-full">
          ...
          <h1
            class="mt-1 text-21xl font-bold text-center leading-[48.4px] text-midnightblue max-md:max-w-full"
          >
            TRANSPORT DE MARCHANDISE
          </h1>
          <p
            class="mt-11 font-medium text-base leading-7 text-center text-zinc-700 max-md:mt-10 max-md:max-w-full"
          >
          ...
          <div class="self-stretch mt-20 max-md:mt-10 max-md:max-w-full">
            <div class="flex gap-5 max-md:flex-col max-md:gap-0">
              <div class="flex flex-col w-[33%] max-md:ml-0 max-md:w-full">
                <div
                  class="flex flex-col items-end self-stretch my-auto max-md:mt-10"
                >
                  <div
                    class="flex justify-center items-center px-4 bg-cornflowerblue-100 h-[90px] rounded-[100px] w-[90px]"
                  >
                    <img
                      loading="lazy"
                      src="<?= get_template_directory_uri() ?>/assets/images/icons/truck-location-icon.svg"
                      alt=""
                      class="w-full aspect-[1.39]"
                    />
                  </div>
                  <h2
                    class="mt-5 text-3xl-2 font-bold leading-6 text-right text-midnightblue"
                  >
                    TRACEZ ET SURVEILLEZ
                  </h2>
                  <p
                    class="self-stretch font-medium mt-3.5 text-base leading-7 text-right text-zinc-700"
                  >
                    Vous pouvez visualiser d’un coup d’œil l’ensemble de vos
                    traceurs, les renommer et vérifier leur état de santé.
                  </p>
                  <div
                    class="flex justify-center items-center px-7 mt-16 bg-cornflowerblue-100 h-[89px] rounded-[100px] w-[89px] max-md:px-5 max-md:mt-10"
                  >
                    <img
                      loading="lazy"
                      src="<?= get_template_directory_uri() ?>/assets/images/icons/bell-icon.svg"
                      alt=""
                      class="w-full aspect-[0.93]"
                    />
                  </div>
                  <h2
                    class="mt-5 text-3xl-2 font-bold leading-6 text-right text-midnightblue"
              ...
              <div class="flex flex-col ml-5 w-[33%] max-md:ml-0 max-md:w-full">
                <div class="flex flex-col self-stretch my-auto max-md:mt-10">
                  ...
                  >
                    <img
                      loading="lazy"
                      src="<?= get_template_directory_uri() ?>/assets/images/icons/subscription-icon.svg"
                      alt=""
                      class="w-full aspect-[0.97]"
                    />
                  </div>
                  <h2
                    class="mt-5 text-3xl-2 font-bold leading-6 text-midnightblue"
                  >
                    ABONNEMENT OFFERT
                  </h2>
                  <p
                    class="mt-3.5 font-medium text-base leading-7 text-zinc-700"
                  >
                    La première année d'abonnement est offerte, puis
                    l'abonnement est de 3,90€ TTC par mois et par traceur.
                  </p>
                  <div
                    class="flex justify-center items-center px-5 mt-16 bg-cornflowerblue-100 h-[89px] rounded-[100px] w-[89px] max-md:mt-10"
                  >
                    <img
                      loading="lazy"
                      src="<?= get_template_directory_uri() ?>/assets/images/icons/theive-icon.svg"
                      alt=""
                      class="w-full aspect-[1.23]"
                    />
                  </div>
                  <h2
                    class="mt-5 text-3xl-2 font-bold leading-6 text-midnightblue textl"
                  >
                    DÉCLAREZ UN VOL
                  </h2>
                  <p
          ...
          <section
        class="relative flex justify-center items-center self-stretch px-16 max-md:px-5"
      >
        <div
          class="relative z-40 flex flex-col items-center w-full max-w-[1444px] max-md:max-w-full"
        >
          <div
            class="flex overflow-hidden relative flex-col justify-center items-center px-16 py-20 max-w-full min-h-[451px] w-[864px] max-md:px-5"
          >
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/be4cc19752c58523c1a24f916b627025c22ab3cf9dfacdeecbd0b148ddb8cce9?apiKey=abfef66409b54744a10f8b8237a66f58&"
              alt=""
              class="object-cover absolute inset-0 size-full"
            />
            <img
              loading="lazy"
              src="https://cdn.builder.io/api/v1/image/assets/TEMP/5a9ef51ba47e797e8c292978f885c96d400354505b1deb3cd70e72e187177e51?apiKey=abfef66409b54744a10f8b8237a66f58&"
              alt="App Icon"
              class="mt-28 mb-16 aspect-[0.99] fill-white w-[74px] max-md:my-10"
            />
          </div>
          <h6
            class="mt-32 text-21xl-4 font-semibold leading-7 text-center text-sky-500 max-md:mt-10 max-md:max-w-full max-md:text-4xl"
          >
            Télécharger votre app
          </h6>
          <p
            class="mt-10 font-normal text-lg leading-7 text-center text-white max-md:max-w-full"
          >
          ...
          >
            ...
            >
              <img
                loading="lazy"
                src="<?= get_template_directory_uri() ?>/assets/images/icons/play-store-icon.svg"
                alt="Play Store Icon"
                class="shrink-0 my-auto aspect-[0.89] fill-white w-[33px]"
              />
            ...
            >
              <img
                loading="lazy"
                src="<?= get_template_directory_uri() ?>/assets/images/icons/app-store-icon.svg"
                alt="App Store Icon"
                class="shrink-0 my-auto w-8 aspect-[0.86] fill-white"
              />
              <div class="text-xl font-normal">
              <span class="text-white">Available On<br />
                App Store</span>
          ...
          <main
            class="flex flex-col justify-center items-center self-stretch px-16 py-20 mt-28 bg-white rounded-[65px] max-md:px-5 max-md:mt-10 max-md:max-w-full"
          >
            <h2
              class="mt-6 text-21xl-4 font-bold leading-loose text-center text-midnightblue max-md:text-4xl"
            >
              App Screenshots
            </h2>
            <p
              class="mt-12 font-normal text-base leading-7 text-center text-zinc-700 max-md:mt-10 max-md:max-w-full"
            >
              Nous vous offrons des solutions sur mesure pour pouvoir gèrer
                ...
                <div class="swiper-wrapper">
                  ...
                  <div class="swiper-slide">
                    ...
                    />
                      ...
                      <!-- Pagination -->
                      <div
                  class="self-center flex justify-center swiper-screenshots-pagination"
                ></div>
              </div>
            </div>
          </main>
        ...
        />
            ...
            <!-- * ---- VOTRE APPLICATION ---- * -->
            <section
        class="self-stretch px-5 pb-20 lg:pb-16 2xl:px-0 max-w-screen-xl mx-auto flex flex-col-reverse lg:flex-row items-center justify-center gap-[70px] text-left text-lg text-cornflowerblue-100 font-poppins"
      >
        <div
          class="flex flex-col items-start justify-start gap-12 md:gap-[76px]"
        >
          <div class="flex flex-col items-start justify-start gap-[32px]">
            <div class="flex flex-col items-start justify-start gap-[4px]">
              ...
              <h2
                class="m-0 relative text-21xl-4 leading-[49px] font-bold font-work-sans [display:-webkit-inline-box] overflow-hidden text-ellipsis [-webkit-line-clamp:2] [-webkit-box-orient:vertical] mix-blend-normal text-midnightblue"
              >
                VOTRE <br />APPLICATION
              </h2>
            </div>
            <img
              class="w-[60px] relative h-[3px] mix-blend-normal"
              alt=""
              src="<?= get_template_directory_uri() ?>/assets/images/divider8.svg"
            />

            <div
              class="flex flex-col items-end justify-start gap-[25px] text-mini text-darkslategray-100"
            >
              ...
              <div
                class="max-w-[629.7px] px-6 py-5 rounded-[3px] bg-whitesmoke-200 flex flex-row items-center justify-center gap-[20px] text-base text-midnightblue"
              >
                <img
                  class="w-5 relative h-3.5 mix-blend-normal"
                  alt=""
                  src="<?= get_template_directory_uri() ?>/assets/images/icons/double-vergule-icon.svg"
                />
          ...
          <div
            class="flex w-full flex-col items-center sm:flex-row sm:items-start justify-start gap-[20px]"
          >
            <button
              class="cursor-pointer p-0 bg-[transparent] w-[212px] rounded-[1.67px] box-border h-[58.6px] flex flex-row items-center justify-center gap-[7px] border-[1px] border-solid border-gainsboro"
            >
              <img
                class="w-[13.1px] relative h-[16.2px] mix-blend-normal"
                alt=""
                src="<?= get_template_directory_uri() ?>/assets/images/icons/apple-icon.svg"
              />
            ...
            >
              <img
                ...
                alt=""
                src="<?= get_template_directory_uri() ?>/assets/images/icons/google-icon.svg"
              />
        ...
        <div
          class="flex flex-col items-center justify-start text-center text-sm"
        >
          ...
          <div
            class="w-full max-w-xs sm:max-w-[444.2px] p-5 shadow-[0px_4px_16px_rgba(10,_10,_58,_0.2)] rounded-[17px] bg-white flex flex-col items-center justify-center mt-[-50px]"
          >
            <div
              class="w-full flex flex-col items-start justify-start gap-[6px]"
            >
              <div
              ...
              <div
                class="max-w-[403.9px] w-full rounded-[1.33px] bg-whitesmoke-200 h-[8.1px] flex flex-row items-center justify-start"
              >
                <img
                  class="w-[101px] relative rounded-[1.33px] h-[8.1px] mix-blend-normal"
                  alt=""
              ...
              <div
                class="flex w-full flex-row items-start justify-between text-left text-mini-1 text-gray-100"
              >
