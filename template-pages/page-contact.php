...
<section class="flex flex-col justify-end self-stretch xl:pt-20">
  <div class="self-center mt-20 max-w-screen-xl mx-auto px-5 xl:px-0 w-full max-md:mt-10">
    <div class="flex gap-5 max-md:flex-col max-md:gap-0">
      <div class="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
        <div class="flex flex-col !pt-1 max-md:mt-10 max-md:max-w-full">
          ...
          <h1 class="text-4xl font-bold  text-blue-950 max-md:max-w-full">
            CONTACTEZ-NOUS
          </h1>
          <div class="shrink-0 mt-2 bg-cornflowerblue-100 rounded-sm bg-blend-normal h-[3px] max-w-[250px]"></div>
          <p class="mt-6 text-sm leading-6 text-zinc-700 max-md:max-w-full font-bold">
          ...
          <div class="flex gap-4 self-start mt-7">
            <div class="flex justify-center items-center p-5 bg-cornflowerblue-100 h-[71px] rounded-[50px] w-[71px]">
              <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/icons/phone-icon.svg" alt="Phone Icon" class="aspect-square fill-white w-[30px]" />
            </div>
          ...
          <div class="flex gap-4 self-start mt-7">
            <div class="flex justify-center items-center px-5 py-6 bg-cornflowerblue-100 h-[71px] rounded-[50px] w-[71px]">
              <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/icons/email-icon.svg" alt="Email Icon" class="aspect-[1.37] fill-white w-[30px]" />
            </div>
            <div class="flex flex-col my-auto font-semibold whitespace-nowrap">
          ...
          <div class="flex gap-4 mt-7">
            <div class="flex justify-center items-center px-6 py-5 bg-cornflowerblue-100 h-[72px] rounded-[50px] min-w-[72px] max-md:px-5">
              <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/icons/marker-icon.svg" alt="Location Icon" class="aspect-[0.76] fill-white w-[22px]" />
            </div>
            <div class="flex flex-col my-auto font-semibold max-md:max-w-full">
              <div class="text-base leading-7 text-slate-950 max-md:max-w-full">
                Visitez-nous
              </div>
              <div class="mt-2 text-lg leading-5 text-zinc-700 max-md:max-w-full font-bold">
  ...
  <iframe class="w-full aspect-[3.85] min-h-72 max-md:max-w-full" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d214.10257060133816!2d-9.82045824055208!3d30.84072033344761!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xdb25dbfb1cfa9e9%3A0xa615b3bfe85b4064!2sSurf%20Time%20Morocco!5e0!3m2!1sfr!2sma!4v1695139564169!5m2!1sfr!2sma">
  </iframe>
</section>
