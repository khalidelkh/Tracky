...
<!-- * Contactez-nous * -->
<section class="max-w-screen-xl mx-auto flex justify-center items-center self-stretch px-16 py-20 max-md:px-5">
  <div class="flex flex-col items-center mt-32 max-w-full max-md:mt-10">
    <div>
      ...
      <div class="shrink-0 mt-6 w-16 bg-sky-500 rounded-sm bg-blend-normal h-[3px]"></div>
    </div>
    <p class="mt-6 font-normal text-font-semibold leading-6 text-center text-zinc-700 max-md:max-w-full">
      Toutes les contraintes et besoins que nécessite le transport de
      marchandises <br />
      <span class="text-zinc-700">ont été étudiés par nos équipes pour arriver à satisfaire ce
        créneau trés sensible.</span>
    </p>
    <img loading="lazy" src="<?= get_template_directory_uri() ?>/assets/images/pages/demande-devis/demende-devis-image.webp" alt="Decorative image related to contact" class="self-stretch mt-24 w-full aspect-[2.63] max-md:mt-10 max-md:max-w-full" />
